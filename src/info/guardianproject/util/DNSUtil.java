...
public class DNSUtil {
	 ...
	 */
	private static Map<String, HostAddress> ccache = new Cache<String, HostAddress>(100, 1000 * 60 * 10);
	private static Map<String, HostAddress> scache = new Cache<String, HostAddress>(100, 1000 * 60 * 10);
