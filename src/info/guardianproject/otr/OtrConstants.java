...
public interface OtrConstants {
    ...
    public static final String CommonRequest = " Your contact is requesting to start an encrypted chat. Please install ChatSecure (aka Gibberbot; Android/iOS), Pidgin (Win/Linux), Adium (Mac) or other encryption-enabled app. Learn more at: http://otr.cypherpunks.ca";
