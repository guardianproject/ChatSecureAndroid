...
public class ContactListView extends LinearLayout {
    ...
    public Cursor getContactAtPosition(long packedPosition) {
        ...
        if (type == ExpandableListView.PACKED_POSITION_TYPE_CHILD) {
            ...
            // XXX: so this was the problem with the ExpandableListView object if generated by onLongClick!
            try {
                return (Cursor) mAdapter.getChild(groupPosition, childPosition);
            } catch(NullPointerException e) {
                return (Cursor) mAdapter.getChild(groupPosition - 1, childPosition - 1);
            }
        }
        return null;
    }
