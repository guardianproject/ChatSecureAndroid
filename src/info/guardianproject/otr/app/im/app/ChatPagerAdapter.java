...
import info.guardianproject.otr.app.im.app.NewChatActivity.ChatViewFragment;
...
*/
    ...
    public ChatPagerAdapter(Activity activity, FragmentManager fm) {
    ...
    class ListTreeAdapter extends CursorTreeAdapter {
        ...
        protected void bindChildView(View view, Context context, Cursor cursor, boolean isLastChild) {
            ...
            if (view instanceof TextView) {
                ...
                ((ContactView) view).bind(cursor, null, false);
            }
        }
        ...
        protected View newChildView(Context context, Cursor cursor, boolean isLastChild,
            ...
            if (cursor.getCount() == 0) {
                ...
                return ChatPagerAdapter.this.newChildView(parent);
            }
        }
        ...
        protected View newGroupView(Context context, Cursor cursor, boolean isExpanded,
                ViewGroup parent) {
            return ChatPagerAdapter.this.newGroupView(parent);
        }
