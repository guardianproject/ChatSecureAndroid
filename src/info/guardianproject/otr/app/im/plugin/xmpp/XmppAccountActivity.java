...
public class XmppAccountActivity extends ThemeableActivity {
    ...
    protected void onCreate(Bundle icicle) {
        ...
        mRememberPass.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mRememberPass.isChecked()) {
                    ...
                    Toast.makeText(XmppAccountActivity.this, msg, Toast.LENGTH_LONG).show();
                }
            }
        });
        ...
        mBtnSignIn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    OrbotHelper oh = new OrbotHelper(XmppAccountActivity.this);
                    if (!oh.isOrbotRunning())
                    {
                        oh.requestOrbotStart(XmppAccountActivity.this);
                        return;
                    }
                }
...
//                    Toast.makeText(this, "OTR is not initialized yet", Toast.LENGTH_SHORT).show();
    ...
    void signOutUsingActivity() {
        ...
        Intent intent = new Intent(XmppAccountActivity.this, SignoutActivity.class);
        ...
        public void run() {
            ...
            try {
                if (otrKeyManager != null) {
                    ...
                    Toast.makeText(XmppAccountActivity.this, "OTR is not initialized yet",
                            Toast.LENGTH_SHORT).show();
                }
            } catch (Exception e) {
