...
//    }
    ...
    public static class F2m extends ECPoint
    {
        ...
        /* (non-Javadoc)
         * @see info.guardianproject.bouncycastle.math.ec.ECPoint#getEncoded()
         */
        public byte[] getEncoded()
        {
            if (this.isInfinity()) 
...
//            ECFieldElement.F2m.checkFieldElements(a.x, b.x);
        ...
        /* (non-Javadoc)
         * @see info.guardianproject.bouncycastle.math.ec.ECPoint#add(info.guardianproject.bouncycastle.math.ec.ECPoint)
         */
        public ECPoint add(ECPoint b)
        {
            checkPoints(this, b);
        ...
        /* (non-Javadoc)
         * @see info.guardianproject.bouncycastle.math.ec.ECPoint#subtract(info.guardianproject.bouncycastle.math.ec.ECPoint)
         */
        public ECPoint subtract(ECPoint b)
        {
            checkPoints(this, b);
        ...
        /* (non-Javadoc)
         * @see info.guardianproject.bouncycastle.math.ec.ECPoint#twice()
         */
        public ECPoint twice()
        {
            if (this.isInfinity()) 
