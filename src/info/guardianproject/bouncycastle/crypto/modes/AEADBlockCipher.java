 ...
 * @see info.guardianproject.bouncycastle.crypto.params.AEADParameters
 */
public interface AEADBlockCipher
{
     ...
     * @throws info.guardianproject.bouncycastle.crypto.InvalidCipherTextException if the MAC fails to match.
     */
