...
public interface OtrCryptoEngine {
    ...
    public static final byte[] ZERO_CTR = new byte[] { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    ...
    public abstract BigInteger generateSecret(PrivateKey privKey, PublicKey pubKey)
    ...
    public abstract byte[] getFingerprintRaw(PublicKey pubKey) throws OtrCryptoException;
}
